...
python training/src/train/train_kfold.py model=squeezenet1_1 datamodule.data_dir=data/kfold_train/ model.freeze_layers=false datamodule.batch_size=256 trainer.max_epochs=100 model.optimizer.lr=0.00001
